...
theme.MobileNav = (function() {
  ...
  function openMobileNav() {
    ...
    // Added by Andrew E May 17 2021
    var siteHeaderFixed = document.querySelector('#shopify-section-header');
    siteHeaderFixed.style.position = 'static';
    cache.pageContainer.style.paddingTop = 0;
    window.scrollTo(0, 0);
  }
  ...
  function closeMobileNav() {
    ...
    // Added by Andrew E May 17 2021
    var siteHeaderFixed = document.querySelector('#shopify-section-header');
    siteHeaderFixed.style.position = 'fixed';
    var fixedHeaderHeight = siteHeaderFixed.offsetHeight;
    cache.pageContainer.style.paddingTop = fixedHeaderHeight;
  }
...
function getHeaderHeight() {
  ...
  return `${headerSectionHeight}px`;
}

function setSpacerPadding() {
  const headerSpacer = document.getElementById('stickyHeader');
  if (headerSpacer) {
    headerSpacer.style.paddingTop = getHeaderHeight();
  }
}

window.addEventListener('DOMContentLoaded', setSpacerPadding);
window.addEventListener('resize', setSpacerPadding, 50);